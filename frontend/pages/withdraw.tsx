...
export default function WithdrawPage() {
  ...
  const handleInputChange = (field: keyof WithdrawFormData, value: string | number) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createRule({
        args: [
          false, // isTopup (false for withdraw)
          formData.token,
          formData.recipient,
          amount,
          threshold,
      ...
      toast.success('Auto withdraw rule created successfully!');
      ...
      toast.error('Failed to create auto withdraw rule');
    }
  };
  ...
  if (!isConnected) {
    return (
      <>
        <Head>
          <title>Auto Withdraw - Tevra</title>
        </Head>
        <Layout>
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Connect your wallet to create auto withdraw rules.
              </p>
            </div>
          </div>
        </Layout>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">
              Create Auto Withdraw Rule
            </h1>
            <p className="text-gray-400">
              Set up automated withdrawals when your balance exceeds the threshold.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Trigger withdraw when balance exceeds this amount
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-400 mt-1">
                      Stop withdrawals when balance reaches this amount
                    </p>
                  </div>
            ...
            <div className="space-y-6">
              <div className="card">
                ...
                <div className="space-y-3 text-sm text-gray-300">
                  ...
                  <p>• Automatically withdraw when balance exceeds threshold</p>
              ...
              <div className="card">
                ...
                <div className="space-y-3 text-sm text-gray-300">
                  <p>• Ensure recipient address is correct</p>
